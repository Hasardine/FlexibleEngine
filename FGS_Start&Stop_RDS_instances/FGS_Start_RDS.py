...
# Start instance
# APIG : https://rds.eu-west-0.prod-cloud-ocb.orange-business.com/v3/{project-id}/instances/{instance-id}/action/startup 
...
def handler (event, context):
  ...
  urlRds = "https://rds.eu-west-0.prod-cloud-ocb.orange-business.com/v3/"+projectId+"/instances/"+instanceId+"/action/startup"
